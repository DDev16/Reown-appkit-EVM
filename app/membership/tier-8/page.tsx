                            ...
                            <div className="flex items-center justify-center space-y-2 flex-wrap gap-8">
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="relative px-6 py-2 bg-black rounded-xl group transition-all duration-300 hover:shadow-2xl hover:shadow-[#2ECC71]/20 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
