...
const benefits = [
    {
        title: "Essential Edition NFT",
        icon: <Crown />,
        description: "1600 Osmium Tier NFTs. Dynamic FLR pricing, $150 USD value.",
    },
    {
        title: "Monthly Cost Structure",
        icon: <Coins />,
        description: "$2.50/month standard cost, reducible to $0 with kickback system. Guaranteed profit after 60 months.",
    },
    {
        title: "NFT Cashback Program",
        icon: <ChartBar />,
        description: "20-25% guaranteed cashback in FLR, quarterly payouts with partial guarantee.",
    },
    {
        title: "Token Package",
        icon: <Coins />,
        description: "400 DBW tokens with regular airdrops.",
    },
    {
    ...
    useEffect(() => {
        ...
        if (isConfirmed) {
            ...
            if (transactionType === 'approval') {
                ...
                Swal.fire({
                    title: 'Congratulations on your Tier-7 NFT! 🎉',
                ...
                <div className="max-w-8xl mx-auto px-4 sm:px-4 lg:px-5 relative z-10 flex flex-col justify-center py-8">
                    ...
                    <div className="text-center mb-8">
                        <div className="flex flex-col items-center gap-2 mb-2">
                            <Crown className="w-16 h-16 text-[#1e90ff]" />
                    ...
                    <div className="grid lg:grid-cols-2 gap-4 items-start">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4 flex-wrap gap-4">
                                ...
                                <div className="px-4 py-2 bg-black border border-[#1e90ff] rounded-xl text-center shadow-lg shadow-[#1e90ff]/50 w-full max-w-xs">
                                    <p className="text-gray-300 text-base font-semibold">
                                        Price: <span className="text-[#1e90ff]">${formatPrices().usd} USD</span>
                                    </p>
                                    <p className="text-gray-300 text-base font-semibold">
                                        Current: <span className="text-[#1e90ff]">{formatPrices().flr} FLR</span>
                                    </p>
                                    <p className="text-gray-300 text-base font-semibold">
                                        Supply: <span className="text-[#1e90ff]">{formatSupply()}</span>
                                    </p>
                                </div>
                                        ...
                                        {[PAYMENT_FLR, PAYMENT_USDT, PAYMENT_USDC_E].map((method) => (
                                            <button
                                                ...
                                                className={`px-2 py-2 rounded-lg transition-all duration-200 flex items-center justify-center ${paymentMethod === method
                                                    ...
                                                    : "bg-black/60 border border-[#1e90ff]/30 text-white"
                                                    }`}
                                            >
                                ...
                                <div className="w-full flex flex-col gap-2 max-w-xs">
                                    ...
                                    {paymentMethod !== PAYMENT_FLR && !approvalStatus[paymentMethod] && (
                                        <div className="relative">
                                            <div className="absolute inset-0 bg-gradient-to-r from-[#1e90ff] via-[#1e90ff] to-[#1e90ff] rounded-xl blur-lg opacity-75 group-hover:opacity-100 transition-all duration-500"></div>
                                            <button
                                                onClick={handleApprove}
                                                disabled={isApproving || isMinting || isConfirming}
                                                className="relative w-full px-6 py-2 bg-black rounded-xl group transition-all duration-300 hover:shadow-2xl hover:shadow-[#1e90ff]/20 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                                <div className="absolute inset-0 bg-gradient-to-r from-[#1e90ff] to-[#1e90ff] opacity-0 group-hover:opacity-20 rounded-xl transition-opacity duration-300"></div>
                                                <span className="relative flex items-center justify-center gap-2">
                                                    <DollarSign className="w-5 h-5 text-[#1e90ff] group-hover:scale-110 transition-transform duration-300" />
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            <div className="absolute inset-0 bg-gradient-to-r from-[#1e90ff] to-[#1e90ff] opacity-0 group-hover:opacity-20 rounded-xl transition-opacity duration-300"></div>
                                            <span className="relative flex items-center justify-center gap-2">
                                                <Sparkles className="w-5 h-5 text-[#1e90ff] group-hover:scale-110 transition-transform duration-300" />
                                                <span className="text-base font-semibold text-white">
                                                    {getMintButtonText()}
                                                </span>
                                            </span>
                                ...
                                {referrerAddress && (
                                    <div className="fixed bottom-4 right-4 bg-black z-20 border border-[#1e90ff] rounded-lg p-2 text-sm text-white">
                            ...
                            <div className="relative group max-w-lg mx-auto">
                                <div className="absolute -inset-3 bg-gradient-to-br from-[#1e90ff] via-[#1e90ff] to-[#1e90ff]/50 rounded-2xl opacity-75 group-hover:opacity-100 blur-2xl transition-all duration-500"></div>
                        ...
                        <div className="space-y-2 overflow-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
                                {benefits.map((benefit, index) => (
                                    ...
                                    >
                                        <div className="absolute -inset-[1px] bg-gradient-to-r from-[#1e90ff] via-[#1e90ff] to-[#1e90ff] rounded-xl opacity-0 group-hover:opacity-30 blur-sm transition-opacity duration-500"></div>
                                        <div className="relative">
                                            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#1e90ff] to-[#1e90ff] p-2 mb-2">
                            ...
                            {/* Education Banner */}
                            <div className="p-4 rounded-xl bg-gradient-to-r from-[#1e90ff] to-[#1e90ff] relative overflow-hidden">
                                <div
                            ...
                            <div className="mt-4 text-center">
                                <a
                                    ...
                                    className="inline-flex items-center px-6 py-3 bg-black border border-[#1e90ff] text-[#1e90ff] rounded-xl hover:bg-[#1e90ff]/10 transition-all duration-300 group"
                                >
