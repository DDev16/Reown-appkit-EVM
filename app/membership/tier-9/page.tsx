...
const benefits = [
    {
        ...
        icon: <Crown />,
        description: "6400 Palladium Tier NFTs. Dynamic FLR pricing, $37.50 USD value.",
    },
    {
        title: "Monthly Cost Structure",
        icon: <Coins />,
        description: "$0.63/month standard cost, reducible to $0 with kickback system. Guaranteed profit after 60 months.",
    },
    {
        title: "NFT Cashback Program",
        icon: <ChartBar />,
        description: "11.25-15% guaranteed cashback in FLR, quarterly payouts with partial guarantee.",
    },
    {
        title: "Token Package",
        icon: <Coins />,
        description: "100 DBW tokens with regular airdrops.",
    },
    {
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4 flex-wrap gap-4">
                                ...
                                <div className="px-4 py-2 bg-black border border-[#FFD700] rounded-xl text-center shadow-lg shadow-[#FFD700]/50 w-full max-w-xs">
                                    ...
                                    <p className="text-gray-300 text-base font-semibold">
                                        Current: <span className="text-[#FFD700]">{formatPrices().flr} FLR</span>
                                    </p>
                                    <p className="text-gray-300 text-base font-semibold">
                            ...
                            <div className="relative group max-w-lg mx-auto">
                                <div className="absolute -inset-3 bg-gradient-to-br from-[#FFD700] via-[#FFD700] to-[#FFD700]/50 rounded-2xl opacity-75 group-hover:opacity-100 blur-2xl transition-all duration-500"></div>
                        ...
                        <div className="space-y-2 overflow-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
                                {benefits.map((benefit, index) => (
                                    ...
                                    >
                                        <div className="absolute -inset-[1px] bg-gradient-to-r from-[#FFD700] via-[#FFD700] to-[#FFD700] rounded-xl opacity-0 group-hover:opacity-30 blur-sm transition-opacity duration-500"></div>
                                        <div className="relative">
                                            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#FFD700] to-[#FFD700] p-2 mb-2">
                            ...
                            {/* Education Banner */}
                            <div className="p-4 rounded-xl bg-gradient-to-r from-[#FFD700] to-[#FFD700] relative overflow-hidden">
                                <div
                            ...
                            <div className="mt-4 text-center">
                                <a
                                    ...
                                    className="inline-flex items-center px-6 py-3 bg-black border border-[#FFD700] text-[#FFD700] rounded-xl hover:bg-[#FFD700]/10 transition-all duration-300 group"
                                >
