...
const Tier9Page = () => {
    ...
    const formatSupply = () => {
        if (!supplyData || !Array.isArray(supplyData)) return "0/6400";
    ...
    return (
        <div className="min-h-screen text-white overflow-auto">
            ...
            <div className="relative min-h-screen">
                {/* Background Gradients - Updated to Rhenium theme */}
                <div className="absolute inset-0 bg-gradient-radial from-[#FFD700]/20 via-transparent to-transparent opacity-40"></div>
                <div className="absolute top-0 right-0 w-1/2 h-full bg-gradient-to-l from-[#FFD700]/10 to-transparent"></div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#FFD700] to-[#FFC000]">
                                        Rhenium Tier NFT
                                    </h1>
                                </div>
                            ...
                            <div className="flex items-center justify-center space-y-2 flex-wrap gap-8">
                                ...
                                <div className="relative">
                                    <div className="absolute inset-0 bg-gradient-to-r from-[#FFD700] via-[#FFC000] to-[#FFD700] rounded-xl blur-lg opacity-75 group-hover:opacity-100 transition-all duration-500"></div>
                                    <button
                                        onClick={handleMint}
                                    ...
                                    >
                                        <div className="absolute inset-0 bg-gradient-to-r from-[#FFD700] to-[#FFC000] opacity-0 group-hover:opacity-20 rounded-xl transition-opacity duration-300"></div>
                            ...
                            <div className="relative group">
                                <div className="absolute -inset-3 bg-gradient-to-br from-[#FFD700] via-[#FFC000] to-[#FFD700]/50 rounded-2xl opacity-75 group-hover:opacity-100 blur-2xl transition-all duration-500"></div>
                        ...
                        <div className="space-y-2 overflow-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2">
                                {benefits.map((benefit, index) => (
                                    <div
                                        key={index}
                                        className="benefit-card opacity-0 group relative p-4 rounded-xl bg-gradient-to-br from-gray-900 to-black border border-[#FFD700]/20 hover:border-[#FFD700]/40 transition-all duration-300"
                                        style={{ animationDelay: `${index * 100}ms` }}
                                    >
                                        <div className="absolute -inset-[1px] bg-gradient-to-r from-[#FFD700] via-[#FFC000] to-[#FFD700] rounded-xl opacity-0 group-hover:opacity-30 blur-sm transition-opacity duration-500"></div>
                                        <div className="relative">
                                            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#FFD700] to-[#FFC000] p-2 mb-2">
                            ...
                            {/* Education Banner */}
                            <div className="p-4 rounded-xl bg-gradient-to-r from-[#FFD700] to-[#FFC000] relative overflow-hidden">
                                <div
