...
const benefits = [
    {
        ...
        icon: <Crown />,
        description: "12800 Silver Tier NFTs. Dynamic FLR pricing, $18.75 USD value.",
    },
    {
    ...
    useEffect(() => {
        ...
        if (isConfirmed) {
            ...
            if (transactionType === 'approval') {
                ...
                Swal.fire({
                    title: 'Congratulations on your Tier-10 NFT! 🎉',
                    ...
                    <div className="grid lg:grid-cols-2 gap-4 items-start">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4 flex-wrap gap-4">
                                ...
                                <div className="px-4 py-2 bg-black border border-[#F453F3] rounded-xl text-center shadow-lg shadow-[#F453F3]/50 w-full max-w-xs">
                                        ...
                                        {[PAYMENT_FLR, PAYMENT_USDT, PAYMENT_USDC_E].map((method) => (
                                            <button
                                                ...
                                                className={`px-2 py-2 rounded-lg transition-all duration-200 flex items-center justify-center ${paymentMethod === method
                                                    ? "bg-[#F453F3] text-black font-semibold"
                                                    : "bg-black/60 border border-[#F453F3]/30 text-white"
                                                    }`}
                                            >
                                    ...
                                    {paymentMethod !== PAYMENT_FLR && !approvalStatus[paymentMethod] && (
                                        <div className="relative">
                                            ...
                                            <button
                                                ...
                                                className="relative w-full px-6 py-2 bg-black rounded-xl group transition-all duration-300 hover:shadow-2xl hover:shadow-[#F453F3]/20 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                                ...
                                                <span className="relative flex items-center justify-center gap-2">
                                                    <DollarSign className="w-5 h-5 text-[#F453F3] group-hover:scale-110 transition-transform duration-300" />
