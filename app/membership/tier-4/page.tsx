...
const TIER_4 = 3; // Top tier
// Updated benefits for Tier 4 (Gold)
const benefits = [
    {
        title: "Professional Membership NFT",
        icon: <Crown />,
        description: "200 Gold Tier NFTs. Dynamic FLR pricing, $1,200 USD value.",
    },
    {
        title: "Monthly Cost Structure",
        icon: <Coins />,
        description: "$20/month standard cost, reducible to $0 with kickback system. Guaranteed profit after 60 months.",
    },
    {
    ...
    },
    {
        title: "Revenue Share",
        icon: <ChartBar />,
        description: "25% share from 50% of company assets, distributed monthly.",
    },
    {
        title: "Token Package",
        icon: <Coins />,
        description: "4,000 DBW, 3,750 TDB, 3,000 DBWF, 3,000 DBWL tokens.",
    },
    {
        title: "Educational Resources",
        icon: <BookOpen />,
        description: "Access to Tier 4 blog, public blog, library, dictionary, and e-books.",
    },
    {
        title: "Video Education",
        icon: <Play />,
        description: "Full access to video library and Tier 4 courses.",
    },
    {
    ...
    },
    {
        ...
        icon: <Video />,
        description: "Bi-monthly zoom meetings (every 2 months).",
    },
    {
    ...
    },
    {
        ...
        icon: <Ticket />,
        description: "4 GOLD tier sweepstake entries for 2025 draws.",
    },
    {
        title: "Monthly Sweepstakes",
        icon: <Ticket />,
        description: "Monthly entries for DBW, TDB, NFTC, DBWF, DBWL 2025 sweepstakes.",
    },
    {
        title: "Pool Share",
        icon: <ChartBar />,
        description: "25% share from 35% of sweepstake pools.",
    },
    {
    ...
    useEffect(() => {
        ...
        if (isConfirmed) {
            ...
            if (transactionType === 'approval') {
                ...
                Swal.fire({
                    title: 'Congratulations on your Tier-4 NFT! 🎉',
                ...
                <div className="max-w-8xl mx-auto px-4 sm:px-4 lg:px-5 relative z-10 flex flex-col justify-center py-8">
                    ...
                    <div className="text-center mb-8">
                        <div className="flex flex-col items-center gap-2 mb-2">
                            <Crown className="w-16 h-16 text-[#DAA520]" />
                    ...
                    <div className="grid lg:grid-cols-2 gap-4 items-start">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-col items-center justify-center space-y-4 flex-wrap gap-4">
                                ...
                                <div className="px-4 py-2 bg-black border border-[#DAA520] rounded-xl text-center shadow-lg shadow-[#DAA520]/50 w-full max-w-xs">
                                    <p className="text-gray-300 text-base font-semibold">
                                        Price: <span className="text-[#DAA520]">${formatPrices().usd} USD</span>
                                    </p>
                                    <p className="text-gray-300 text-base font-semibold">
                                        Current: <span className="text-[#DAA520]">{formatPrices().flr} FLR</span>
                                    </p>
                                    <p className="text-gray-300 text-base font-semibold">
                                        Supply: <span className="text-[#DAA520]">{formatSupply()}</span>
                                    </p>
                                </div>
                                        ...
                                        {[PAYMENT_FLR, PAYMENT_USDT, PAYMENT_USDC_E].map((method) => (
                                            <button
                                                ...
                                                className={`px-2 py-2 rounded-lg transition-all duration-200 flex items-center justify-center ${paymentMethod === method
                                                    ...
                                                    : "bg-black/60 border border-[#DAA520]/30 text-white"
                                                    }`}
                                            >
                                ...
                                <div className="w-full flex flex-col gap-2 max-w-xs">
                                    ...
                                    {paymentMethod !== PAYMENT_FLR && !approvalStatus[paymentMethod] && (
                                        <div className="relative">
                                            <div className="absolute inset-0 bg-gradient-to-r from-[#DAA520] via-[#DAA520] to-[#DAA520] rounded-xl blur-lg opacity-75 group-hover:opacity-100 transition-all duration-500"></div>
                                            <button
                                                onClick={handleApprove}
                                                disabled={isApproving || isMinting || isConfirming}
                                                className="relative w-full px-6 py-2 bg-black rounded-xl group transition-all duration-300 hover:shadow-2xl hover:shadow-[#DAA520]/20 disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                                <div className="absolute inset-0 bg-gradient-to-r from-[#DAA520] to-[#DAA520] opacity-0 group-hover:opacity-20 rounded-xl transition-opacity duration-300"></div>
                                                <span className="relative flex items-center justify-center gap-2">
                                                    <DollarSign className="w-5 h-5 text-[#DAA520] group-hover:scale-110 transition-transform duration-300" />
                                ...
                                {referrerAddress && (
                                    <div className="fixed bottom-4 right-4 bg-black z-20 border border-[#DAA520] rounded-lg p-2 text-sm text-white">
                            ...
                            <div className="relative group max-w-lg mx-auto">
                                <div className="absolute -inset-3 bg-gradient-to-br from-[#DAA520] via-[#DAA520] to-[#DAA520]/50 rounded-2xl opacity-75 group-hover:opacity-100 blur-2xl transition-all duration-500"></div>
                        ...
                        <div className="space-y-2 overflow-auto">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
                                {benefits.map((benefit, index) => (
                                    ...
                                    >
                                        <div className="absolute -inset-[1px] bg-gradient-to-r from-[#DAA520] via-[#DAA520] to-[#DAA520] rounded-xl opacity-0 group-hover:opacity-30 blur-sm transition-opacity duration-500"></div>
                                        <div className="relative">
                                            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#DAA520] to-[#DAA520] p-2 mb-2">
                            ...
                            {/* Education Banner */}
                            <div className="p-4 rounded-xl bg-gradient-to-r from-[#DAA520] to-[#DAA520] relative overflow-hidden">
                                <div
                            ...
                            <div className="mt-4 text-center">
                                <a
                                    ...
                                    className="inline-flex items-center px-6 py-3 bg-black border border-[#DAA520] text-[#DAA520] rounded-xl hover:bg-[#DAA520]/10 transition-all duration-300 group"
                                >
