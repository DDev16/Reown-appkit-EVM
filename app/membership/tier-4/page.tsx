...
const benefits = [
    ...
    },
    {
        title: "Token Package",
        icon: <Coins />,
        description: "4,000 DBW, 3,750 TDB, 3,750 DRKET, 3,000 DBWF, 3,000 DBWL tokens.",
    },
    {
    ...
    },
    {
        ...
        icon: <Ticket />,
        description: "Monthly entries for DBW, TDB, DRKET, NFTC, DBWF, DBWL 2025 sweepstakes.",
    },
    {
        title: "Pool Share",
        icon: <ChartBar />,
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-center space-y-2 flex-wrap gap-8">
                                ...
                                <div className="relative">
                                    ...
                                    {referrerAddress && (
                                        <div className="fixed z-20 bottom-4 right-4 bg-black border border-[#DAA520] rounded-lg p-2 text-sm text-white">
