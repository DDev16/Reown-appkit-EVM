...
// Token ID for Tier 1
const TIER_8 = 7; // Assuming tier 1 has ID 0, adjust if different

export default function Tier8Page() {
    // Current tier
    const currentTier = 8;
        ...
        <div className="w-full h-full bg-black text-white">
            ...
            <div className="mb-6 px-1">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold text-white"> Tier 8 Dashboard</h1>
                    <button
                        onClick={refreshData}
