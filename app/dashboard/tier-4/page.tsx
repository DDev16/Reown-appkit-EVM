...
export default function Tier1Page() {
    ...
    useEffect(() => {
        if (tierBalance !== undefined) {
            // User is authorized if they have at least 1 token of TIER_4
                ...
                <div className="text-center space-y-4">
                    ...
                    <div className="space-y-2">
                        <button className="px-6 py-2 bg-red-600 rounded-lg hover:bg-red-700 transition-colors">
                            Purchase Tier 4 Membership
                        </button>
                        <p className="text-sm text-gray-500">
                            Already own a Tier 4 NFT? Make sure it&apos;s in your connected wallet.
                        </p>
                    </div>
                </div>
            </div>
    ...
    return (
        <div className="space-y-6">
            <div className="border-b border-red-900/30 pb-6">
                <h1 className="text-3xl font-bold">Tier 4 - Foundation</h1>
