...
export default function Tier2Page() {
    ...
    // Get analytics for ONLY tier 2 content - using the tier-specific hook
    const {
        analytics,
    ...
    // Stat cards data with blue theme for Tier 2
    const statCards: Array<{
        ...
        textColor: string
            ...
            },
            {
                ...
                bgColor: 'from-black to-blue-950',
                iconBg: 'bg-blue-900',
                borderColor: 'border-blue-800',
                textColor: 'text-blue-400'
            },
        ...
        <div className="w-full h-full bg-black text-white">
            ...
            <div className="mb-6 px-1">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold text-white">Rhodium Dashboard</h1>
                    <button
                        onClick={refreshData}
                        className="flex items-center justify-center px-4 py-2 bg-blue-800 hover:bg-blue-700 rounded text-sm font-medium transition-colors"
                    >
                ...
                {(activeTab === 'all' || activeTab === 'videos') && (
                    <div className="bg-zinc-900 rounded-lg overflow-hidden border border-zinc-800">
                        <div className="border-b border-zinc-800 px-4 py-3 flex items-center justify-between">
                            ...
                            <div className="flex items-center">
                                <span className="px-2 py-1 bg-blue-900 text-blue-100 rounded text-xs font-medium">
                                    {videos.length}
                                </span>
                                {activeTab === 'all' && (
                                    <button
