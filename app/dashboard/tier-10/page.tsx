...
// Token ID for Tier 1
const TIER_10 = 9; // Assuming tier 1 has ID 0, adjust if different

export default function Tier10Page() {
    // Current tier
    const currentTier = 10;
    ...
    useEffect(() => {
        if (tierBalance !== undefined) {
            // User is authorized if they have at least 1 token of TIER_10
            ...
            <div className="min-h-[80vh] flex items-center justify-center">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-400">
                        You need to hold the Tier 10 token to access this content
                    </p>
                    <div className="space-y-2">
                        <button className="px-6 py-2 bg-red-600 rounded-lg hover:bg-red-700 transition-colors">
                            Purchase Tier 10 Membership
                        </button>
                        <p className="text-sm text-gray-500">
                            Already own a Tier 10 NFT? Make sure it&apos;s in your connected wallet.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div className="w-full h-full bg-black text-white">
            ...
            <div className="mb-6 px-1">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold text-white"> Tier 10 Dashboard</h1>
                    <button
                        onClick={refreshData}
